...
const NotesGrid = ({ notes, onEditNote, onDeleteNote, onViewNote }) => {
  const today = new Date().toISOString().split('T')[0];
  
  const sampleNotes = [
    {
      id: 1,
      title: "Welcome to RedMatrix Notes",
      content: "This is your first note! Click to edit or add more notes using the sidebar.",
      createdAt: today,
      updatedAt: today
    },
    {
      ...
      content: "You can add, edit, delete, and search through your notes easily with this app.",
      createdAt: today,
      updatedAt: today
    }
  ];

  const displayNotes = notes && notes.length > 0 ? notes : sampleNotes;
    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <button className="px-6 py-2 bg-[#DC143C] text-white rounded-lg hover:bg-[#B91C3C] transition-colors duration-200">
          ...
          >
            ...
            <div className="px-4 py-3 bg-[#FDEBD0] border-t border-[#F7CAC9] rounded-b-lg">
              <div className="flex items-center justify-between">
                ...
                <svg className="w-4 h-4 text-[#DC143C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
